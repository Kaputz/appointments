 ...
 */
class Version20180328164534 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user ADD supplier_id INT DEFAULT NULL, DROP supplier_vg');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user ADD supplier_vg VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, DROP supplier_id');
    }
}
